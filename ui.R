...
navbarPage("MTGO results analysis",
           ...
           tabPanel("Presence",
                    sidebarPanel(
                      ...
                      checkboxInput(inputId = "presencePaper", 
                                    label = h4("Major Official Paper Events"), 
                                    value = TRUE),
                      bsPopover(id = "presencePaper", 
                                title = "Major Official Paper Events",
                                content = "Indicate whether you want to include or not paper event data.", 
                                placement = "top", 
                                trigger = "hover"),
           ...
           tabPanel("Winrate",
                    sidebarPanel(
                      ...
                      checkboxInput(inputId = "winratePaper", 
                                    label = h4("Major Official Paper Events"), 
                                    value = TRUE),
                      bsPopover(id = "winratePaper", 
                                title = "Major Paper Event data",
                                content = "Indicate whether you want to include or not paper event data.", 
                                placement = "top", 
                                trigger = "hover"),
           ...
           tabPanel("Winrate vs Presence (full)",
                    sidebarPanel(
                      ...
                      checkboxInput(inputId = "wvpfPaper", 
                                    label = h4("Major Official Paper Events"), 
                                    value = TRUE),
                      bsPopover(id = "wvpfPaper", 
                                title = "Major Paper Event data",
                                content = "Indicate whether you want to include or not paper event data.", 
                                placement = "top", 
                                trigger = "hover"),
           ...
           tabPanel("Winrate vs Presence (most present)",
                    sidebarPanel(
                      ...
                      checkboxInput(inputId = "wvpmpPaper", 
                                    label = h4("Major Official Paper Events"), 
                                    value = TRUE),
                      bsPopover(id = "wvpmpPaper", 
                                title = "Major Paper Event data",
                                content = "Indicate whether you want to include or not paper event data.", 
                                placement = "top", 
                                trigger = "hover"),
           ...
           tabPanel("Tiers",
                    sidebarPanel(
                      ...
                      checkboxInput(inputId = "lcPaper", 
                                    label = h4("Major Official Paper Events"), 
                                    value = TRUE),
                      bsPopover(id = "lcPaper", 
                                title = "Major Paper Event data",
                                content = "Indicate whether you want to include or not paper event data.", 
                                placement = "top", 
                                trigger = "hover"),
           ...
           tabPanel("Archetype details",
                    sidebarPanel(
                      ...
                      checkboxInput(inputId = "dtPaper", 
                                    label = h4("Major Official paper Events"), 
                                    value = TRUE),
                      bsPopover(id = "dtPaper", 
                                title = "Major Paper Event data",
                                content = "Indicate whether you want to include or not Challenge and bigger event data.", 
                                placement = "top", 
                                trigger = "hover"),
           ...
           tabPanel("Deck Lists",
                    sidebarPanel(
                      ...
                      checkboxInput(inputId = "dlPaper", 
                                    label = h4("Major Official Paper Events"), 
                                    value = TRUE),
                      bsPopover(id = "dlPaper", 
                                title = "Major Paper Event data",
                                content = "Indicate whether you want to include or not Challenge and bigger event data.", 
                                placement = "top", 
                                trigger = "hover"),
           ...
           tabPanel("MD Card Winrate",
                    sidebarPanel(
                      ...
                      checkboxInput(inputId = "wrcMDPaper", 
                                    label = h4("Major Official Paper Events"), 
                                    value = TRUE),
                      bsPopover(id = "wrcMDPaper", 
                                title = "Major Paper Event data",
                                content = "Indicate whether you want to include or not Challenge and bigger event data.", 
                                placement = "top", 
                                trigger = "hover"),
           ...
           tabPanel("SB Card Winrate",
                    sidebarPanel(
                      ...
                      checkboxInput(inputId = "wrcSBPaper", 
                                    label = h4("Major Official Paper Events"), 
                                    value = TRUE),
                      bsPopover(id = "wrcSBPaper", 
                                title = "Major Paper Event data",
                                content = "Indicate whether you want to include or not Challenge and bigger event data.", 
                                placement = "top", 
                                trigger = "hover"),
           ...
           tabPanel("Event sources (URL)",
                    sidebarPanel(
                      ...
                      checkboxInput(inputId = "euPaper", 
                                    label = h4("Major Official Paper Events"), 
                                    value = TRUE),
                      bsPopover(id = "euPaper", 
                                title = "Major Paper Event data",
                                content = "Indicate whether you want to include or not Challenge and bigger event data.", 
                                placement = "top", 
                                trigger = "hover")
           ...
           tabPanel("Data description",
                    sidebarPanel(
                      ...
                      checkboxInput(inputId = "eiPaper", 
                                    label = h4("Major Official Paper Events"), 
                                    value = TRUE),
                      bsPopover(id = "eiPaper", 
                                title = "Major Paper Event data",
                                content = "Indicate whether you want to include or not Challenge and bigger event data.", 
                                placement = "top", 
                                trigger = "hover")
